...
export class AppComponent {
  ...
  constructor(private langService: LanguageSwitcherService) {
    ...
    meta.content = "default-src 'self'; script-src 'self' " + config.api_url + "; object-src 'none'; style-src 'self' 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https://cdn.discordapp.com; connect-src 'self' " + config.api_url + " https://discord.com;";
